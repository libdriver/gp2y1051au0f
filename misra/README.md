...
| --------- | ------------------------------------------------------------ | ------------ | ------------------------------------------------------------ | -------- |
| 10.1      | The value of an expression shall not be assigned to an object with a     narrower essential type or of a different essential type category. | incompatible | We use this function to convert driver data and drivers guarantee the safety of the operation. | very low |
...
Detailed reports can be found in /misra/gp2y1051au0f_polyspace_report.pdf.
